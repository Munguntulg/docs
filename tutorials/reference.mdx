...
## Brightness / Contrast (Гэрэлтэл ба ялгарал)
| Шийдэл | Тайлбар |
| --- | --- |
...
- Давхаргыг шинэчлэх (Duplicate layer): `Cmd+J` / `Ctrl+J`
- Шинэ давхарга үүсгэх: `Shift+Cmd+N` / `Shift+Ctrl+N`
- Zoom In / Zoom Out: `Cmd++` / `Ctrl++` and `Cmd+-` / `Ctrl+-`

![Photoshop image open interface showing File → Open dialog](https://photoshopcafe.com/wp-content/uploads/2014/10/window.gif)
